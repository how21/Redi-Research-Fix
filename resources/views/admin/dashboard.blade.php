<x-app-layout>
    ...
    <div x-data="{ openProvinceModal: false, selectedProvince: { id: '', name: ''}, 
        ...
        <div x-show="deleteModalprov" 
            x-cloak
            @keydown.escape.window="deleteModalprov = false"
            class="fixed inset-0 flex justify-center items-center bg-gray-900 bg-opacity-50 backdrop-blur-sm z-50 transition-opacity duration-300"
            @click.self="deleteModalprov = false">
            ...
            <div x-show="deleteModalprov"
                ...
                <!-- Tombol Close -->
                <button @click="deleteModalprov = false" class="absolute top-3 right-3 text-gray-600 hover:text-gray-900 transition">
                    <i class="fa-solid fa-xmark text-xl"></i>
                </button>
                ...
                @if(isset($provinces) && $provinces->isNotEmpty())
                    ...
                    <div class="flex justify-center space-x-4 mt-4">
                        ...
                        <form id="deleteFormProvince" x-bind:action="'/provinces/' + deleteId" method="POST">
                            @csrf
                            @method('DELETE')
        ...
        <div x-show="deleteModalcat" 
            x-cloak
            @keydown.escape.window="deleteModalcat = false"
            class="fixed inset-0 flex justify-center items-center bg-gray-900 bg-opacity-50 backdrop-blur-sm z-50 transition-opacity duration-300"
            @click.self="deleteModalcat = false">
            ...
            <div x-show="deleteModalcat"
                ...
                <!-- Tombol Close -->
                <button @click="deleteModalcat = false" class="absolute top-3 right-3 text-gray-600 hover:text-gray-900 transition">
                    <i class="fa-solid fa-xmark text-xl"></i>
                </button>
                ...
                @if(isset($category) && $category->isNotEmpty())
                    ...
                    <div class="flex justify-center space-x-4 mt-4">
                        ...
                        <form id="deleteFormCategory" x-bind:action="'/categories/' + deleteId" method="POST">
                            @csrf
                            @method('DELETE')
        ...
        <!-- MODAL DELETE BIDANG -->
        <div x-show="deleteModalbid" 
            x-cloak
            @keydown.escape.window="deleteModalbid = false"
            class="fixed inset-0 flex justify-center items-center bg-gray-900 bg-opacity-50 backdrop-blur-sm z-50 transition-opacity duration-300"
            @click.self="deleteModalbid = false">
            ...
            <div x-show="deleteModalbid"
                ...
                <!-- Tombol Close -->
                <button @click="deleteModalbid = false" class="absolute top-3 right-3 text-gray-600 hover:text-gray-900 transition">
                    <i class="fa-solid fa-xmark text-xl"></i>
                </button>
                ...
                @if(isset($bidangs) && $bidangs->isNotEmpty())
                    ...
                    <div class="flex justify-center space-x-4 mt-4">
                        ...
                        <form id="deleteFormBidang" x-bind:action="'/bidangs/' + deleteId" method="POST">
                            @csrf
                            @method('DELETE')
